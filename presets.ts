...
export const PRESETS: Record<StatusLinePreset, PresetDef> = {
  default: {
    leftSegments: ["model", "thinking", "shell_mode", "path", "git", "context_pct", "cache_read", "cache_hit_rate", "cost"],
    rightSegments: [],
  ...
  full: {
    ...
    rightSegments: ["token_in", "token_out", "cache_read", "cache_hit_rate", "cost", "context_pct", "time_spent", "time", "extension_statuses"],
    separator: "powerline",
    colors: DEFAULT_COLORS,
    segmentOptions: {
      model: { showThinkingLevel: false },
  ...
  nerd: {
    ...
    rightSegments: ["token_in", "token_out", "cache_read", "cache_hit_rate", "cache_write", "cost", "context_pct", "context_total", "time_spent", "time", "extension_statuses"],
    separator: "powerline",
    colors: NERD_COLORS,
    segmentOptions: {
      model: { showThinkingLevel: false },
