...
### Added
- **Fixed-editor scroll-away hint toggle** — Added `powerline.showScrollAwayHints` so the scroll-away shortcut card can be hidden while keeping fixed-editor scrolling and chat shortcuts active.
